...
if __name__ == '__main__':
    ...
    adjective = simpledialog.askstring(title = 'computer', prompt = "add a adjective")
    # Get the player to enter a type of liquid
    liquid = simpledialog.askstring(title = 'computer', prompt = "add a liquid")
    # Get the player to enter a body part
    bodypart = simpledialog.askstring(title = 'computer', prompt = "add a bodypart")
    # Get the player to enter a verb
    verb = simpledialog.askstring(title = 'computer', prompt = "add a verb")
    # Get the player to enter a place
    place = simpledialog.askstring(title = 'computer', prompt = "add a place")
    ...
    messagebox.showinfo(title="the river", message=story)
